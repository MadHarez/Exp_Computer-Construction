...
HD_PWD='C:/Users/southernMD/vivado/project_10/project_10/project_10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Fetch_Inst_Code.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Fetch_Inst_Code.tcl -notrace
