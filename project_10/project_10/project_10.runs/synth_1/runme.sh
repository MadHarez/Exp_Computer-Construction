...
HD_PWD='C:/Users/southernMD/vivado/project_10/project_10/project_10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Fetch_Inst_Code.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Fetch_Inst_Code.tcl
