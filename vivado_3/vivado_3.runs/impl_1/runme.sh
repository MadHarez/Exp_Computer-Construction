...
HD_PWD='C:/Users/southernMD/vivado/vivado_3/vivado_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pre_4_adder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pre_4_adder.tcl -notrace
